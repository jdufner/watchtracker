...
package de.jdufner.watchtracker.metadataextractor.exception;
 ...
 * @since 0.3
 */
public class MetadataextractorExceptionTest {

  @Test
  public void whenCreate_expectExpectExceptionClass() {
    // act
    final MetadataextractorException metadataextractorException = new MetadataextractorException(new Exception());

    // assert
    assertThat(metadataextractorException).isInstanceOf(Exception.class);
  }
